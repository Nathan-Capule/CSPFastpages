...
type: ap 
week: 31
nb_path: _notebooks/2023-04-28-SASSFundamentals.ipynb
layout: notebook
---
...
#################################################
# file to edit: _notebooks/2023-04-28-SASSFundamentals.ipynb
-->
...
<strong>Changes the color to blue</strong></li>
</ul>
...
<p>Variables: Sass allows you to declare variables that can be used throughout your stylesheet. This feature is not available in CSS, and can make your code more maintainable by allowing you to reuse values in multiple places. For example, you could define a primary color variable and then use it in all your buttons, headings, and links.</p>
<p>Nesting: In Sass, you can nest selectors inside each other, making your code more organized and easier to read. This feature is not available in CSS, and can reduce repetition by allowing you to specify the hierarchy of elements more explicitly.</p>
<p>Mixins: Sass allows you to define reusable chunks of code, called mixins, that can be included in other styles. This feature is similar to functions in programming languages, and can make your code more modular and easier to maintain.</p>
<p>Functions: Sass also allows you to define custom functions that can be used in your styles. This feature is similar to mixins, but can return values that can be used in calculations or other styles.</p>
<p>Overall SASS can make life easier for coders as it provides a simple/easy way to add functionality when compared to css. This could have been useful in my original project from last tri as we could have created animations with ease using SASS instead of having blocky transitions through CSS.</p>
<h2 id="NOTE:-Worked-on-this-with-Azeem">NOTE: Worked on this with Azeem<a class="anchor-link" href="#NOTE:-Worked-on-this-with-Azeem"> </a></h2><h2 id="Part-2:-Sass-Demo-0.5+-Points">Part 2: Sass Demo 0.5+ Points<a class="anchor-link" href="#Part-2:-Sass-Demo-0.5+-Points"> </a></h2><ul>
...
<p>We used modular scss, nesting, and variables to help within the display :)</p>
<p><a href="https://azeem-khan1.github.io/UIhacks/">Here</a> is the deployed  server with proof</p>
<p>Code can be found <a href="https://github.com/azeem-khan1/UIhacks">here</a></p>
